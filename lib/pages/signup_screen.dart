...
import 'package:allotracteur/auth_collection.dart';
import 'package:allotracteur/pages/otp_verification_screen.dart';
...
class _SignupScreenState extends State<SignupScreen> {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          Container(
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: const [Color(0xffe56d4b), Color(0xfff19066)],
              ),
  ...
  Future<void> _signup() async {
    ...
    try {
      ...
      final lastName =
          nameParts.length > 1 ? nameParts.skip(1).join(' ') : nameParts.first;
