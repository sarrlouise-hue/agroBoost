            ...
            child: tractors.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      debugPrint(
                          '👷 MGMT DEBUG: ${tractor['name']} - Image: ${tractor['imageUrl'] != null ? (tractor['imageUrl'] as String).substring(0, (tractor['imageUrl'] as String).length > 50 ? 50 : (tractor['imageUrl'] as String).length) : "NULL"}');
