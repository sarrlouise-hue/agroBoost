...
import 'package:allotracteur/components/admin_profile_bottom_sheet.dart';
import 'package:allotracteur/pages/users_management_screen.dart';
import 'package:allotracteur/pages/tractors_management_screen.dart';
import 'package:allotracteur/pages/stats_screen.dart';
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.bodyMedium?.copyWith(color: const Color(0xff4caf50)),
            ),
            const SizedBox(height: 16.0),
            Text(
              isWolof
  ...
  Widget _buildLoginEntry(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.login_rounded, color: Colors.green.shade600, size: 20.0),
          const SizedBox(width: 12.0),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildToggleSettingCard(
            ...
            onChanged: (val) {
              languageProvider.setLanguage(val ? 'wo' : 'fr');
            },
          ),
          const SizedBox(height: 12.0),
          _buildSettingsCard(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: const Color(0xffff9800), size: 20.0),
          ),
          const SizedBox(width: 12.0),
          Expanded(
            child: Column(
