...
import 'package:allotracteur/models/user_model.dart';
...
import 'package:allotracteur/components/interactive_map_screen.dart';
  ...
  TractorData _serviceToTractor(ServiceModel service) {
    ...
    return TractorData(
      ...
      technicalSpecifications: (() {
        Map<String, dynamic> specs = Map<String, dynamic>.from(
