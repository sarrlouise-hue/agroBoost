...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    super.initState();
    _phoneController.text = '771234567';
  }
            ...
            prefixIcon: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 8.0),
                  Text('+221', style: Theme.of(context).textTheme.bodyLarge),
                  const SizedBox(width: 8.0),
                  Container(
                    width: 1.0,
                    height: 24.0,
  ...
  Widget _buildBottomBar(bool isWolof) {
    bool isValid =
        _phoneController.text.length == 9 && _pinController.text.length == 4;
    return Container(
      padding: const EdgeInsets.all(20.0),
      decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          isWolof ? 'STATUT: DEMANDÉ' : 'STATUT: DEMANDÉ',
                          style: const TextStyle(
                            color: Color(0xff2d5016),
                            fontWeight: FontWeight.bold,
                            fontSize: 12.0,
