...
const options = {
	definition: {
		...
		info: {
			...
			version: "1.0.0",
			description:
				"API REST pour la plateforme AlloTracteur - Réservation de services agricoles au Sénégal",
			contact: {
				name: "AlloTracteur",
				...
				LoginRequest: {
					...
					properties: {
						...
						password: {
							...
							example: "password123",
							description:
								"Mot de passe (optionnel si l'utilisateur n'a pas de mot de passe)",
						},
					},
				},
				RefreshTokenRequest: {
				...
				CreateBookingRequest: {
					...
					properties: {
						...
						endTime: {
							...
							pattern: "^([0-1][0-9]|2[0-3]):[0-5][0-9]$",
							description:
								"Heure de fin (HH:MM) - requis si duration non fourni",
							example: "17:00",
						},
						duration: {
							type: "integer",
		...
		tags: [
			...
			},
			{
				name: "Admin",
				description:
					"Endpoints d'administration (admin seulement) - Gestion complète des utilisateurs, prestataires, réservations, avis et notifications",
			},
		],
	},
	// Normaliser les chemins avec des forward slashes pour la compatibilité Windows/Glob
	apis: [
		path.join(routesPath, "*.js").replace(/\\/g, "/"),
		appPath.replace(/\\/g, "/"),
	],
};
