 ...
 *                 message:
 *                   type: string
 *                   example: Utilisateur inscrit avec succès. Veuillez vérifier l'OTP.
 *                 data:
 ...
 *     responses:
 *       200:
 *         description: OTP vérifié avec succès. Compte activé.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: OTP vérifié avec succès. Compte activé.
 *                 data:
 *                   $ref: '#/components/schemas/AuthResponse'
 *       400:
